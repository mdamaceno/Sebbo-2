...
class ProductOrdersControllerTest < ActionController::TestCase
  ...
  test "should create product_order" do
    assert_difference('ProductOrder.count') do
      post :create, product_order: { description: @product_order.description, name: @product_order.name, order_id: @product_order.order_id, price: @product_order.price, quantity: @product_order.quantity }
    end
  ...
  test "should update product_order" do
    patch :update, id: @product_order, product_order: { description: @product_order.description, name: @product_order.name, order_id: @product_order.order_id, price: @product_order.price, quantity: @product_order.quantity }
    assert_redirected_to product_order_path(assigns(:product_order))
  end
